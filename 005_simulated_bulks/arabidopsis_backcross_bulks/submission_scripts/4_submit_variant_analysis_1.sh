...
do
  ...
  do
    ...
    read1="../../mut_${k}_sim_paired_fir.fastq.gz"
    read2="../../mut_${k}_sim_paired_sec.fastq.gz"
    outdir="vars_rep_${k}_mutant"
    /usr/users/sl/rallapag/lib/bsub.rb m-2d 12G "source ruby-2.3.1; rake -f ${rake_file} variants:all ref=${ref} r1=${read1} r2=${read2} dir=${outdir} &>> log_rep_${k}_mut.txt"
  done
done
