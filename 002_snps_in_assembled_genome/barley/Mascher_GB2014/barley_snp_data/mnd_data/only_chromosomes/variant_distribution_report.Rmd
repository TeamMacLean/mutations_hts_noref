...
tenkb <- read.delim(file="per-100000bp-filtered_mnd_samtools_varscan_variants.vcf.txt", header = TRUE)
...
ggplot(data=melted, aes(x=position, y=value)) + geom_bar(stat="identity", colour="#E69F00", fill="#E69F00") +
  ...
  geom_vline(xintercept = c(464124043, 1092466826, 1656894700, 2201062926, 2762474612, 3301229648), size=0.5)
...
tenkb <- read.delim(file="per-500000bp-filtered_mnd_samtools_varscan_variants.vcf.txt", header = TRUE)
tenkb <- re_zero_ratio(tenkb, 1)
melted <- melt(tenkb, id.vars = "position")
ggplot(data=melted, aes(x=position, y=value)) + geom_bar(stat="identity", colour="#E69F00", fill="#E69F00") +
  facet_grid(variable ~ ., scales = "free") +
...
tenkb <- read.delim(file="per-1000000bp-filtered_mnd_samtools_varscan_variants.vcf.txt", header = TRUE)
tenkb <- re_zero_ratio(tenkb, 1)
melted <- melt(tenkb, id.vars = "position")
ggplot(data=melted, aes(x=position, y=value)) + geom_bar(stat="identity", colour="#E69F00", fill="#E69F00") +
  facet_grid(variable ~ ., scales = "free") +
...
tenkb <- read.delim(file="per-5000000bp-filtered_mnd_samtools_varscan_variants.vcf.txt", header = TRUE)
tenkb <- re_zero_ratio(tenkb, 1)
melted <- melt(tenkb, id.vars = "position")
ggplot(data=melted, aes(x=position, y=value)) + geom_bar(stat="identity", colour="#E69F00", fill="#E69F00") +
  facet_grid(variable ~ ., scales = "free") +
...
tenkb <- read.delim(file="per-10000000bp-filtered_mnd_samtools_varscan_variants.vcf.txt", header = TRUE)
tenkb <- re_zero_ratio(tenkb, 1)
melted <- melt(tenkb, id.vars = "position")
ggplot(data=melted, aes(x=position, y=value)) + geom_bar(stat="identity", colour="#E69F00", fill="#E69F00") +
  facet_grid(variable ~ ., scales = "free") +
...
infile <- read.delim(file="varposn-genome-filtered_mnd_samtools_varscan_variants.vcf.txt", header = TRUE)
