...
df1 = process_lengths("pacbio_readlengths/len_SRR1284093.txt", "lib1")
newdf = process_lengths("pacbio_readlengths/len_SRR1284094.txt", "lib2")
df1 <- rbind(df1, newdf)
newdf = process_lengths("pacbio_readlengths/len_SRR1284095.txt", "lib3")
df1 <- rbind(df1, newdf)
newdf = process_lengths("pacbio_readlengths/len_SRR1284096.txt", "lib4")
df1 <- rbind(df1, newdf)
newdf = process_lengths("pacbio_readlengths/len_SRR1284703.txt", "lib5")
df1 <- rbind(df1, newdf)
newdf = process_lengths("pacbio_readlengths/len_SRR1284704.txt", "lib6")
df1 <- rbind(df1, newdf)
newdf = process_lengths("pacbio_readlengths/len_SRR1284705.txt", "lib7")
df1 <- rbind(df1, newdf)
newdf = process_lengths("pacbio_readlengths/len_SRR1284706.txt", "lib8")
df1 <- rbind(df1, newdf)
newdf = process_lengths("pacbio_readlengths/len_SRR1284707.txt", "lib9")
df1 <- rbind(df1, newdf)
...
df1 = read.delim("arabidopsis_assembly_lengths/read_lengths_hasty.txt", header=FALSE)
colnames(df1) <- c("assembly", "length")
df1$assembly <- rep("hasty", nrow(df1))
newdf = read.delim("arabidopsis_assembly_lengths/read_lengths_soc1.txt", header=FALSE)
colnames(newdf) <- c("assembly", "length")
newdf$assembly <- rep("soc1", nrow(newdf))
df1 <- rbind(df1, newdf)
newdf = read.delim("arabidopsis_assembly_lengths/read_lengths_sup1.txt", header=FALSE)
colnames(newdf) <- c("assembly", "length")
newdf$assembly <- rep("sup1", nrow(newdf))
df1 <- rbind(df1, newdf)
newdf = read.delim("arabidopsis_assembly_lengths/frags_ordered_lengths.txt", header=FALSE)
colnames(newdf) <- c("assembly", "length")
newdf$assembly <- rep("exponential", nrow(newdf))
df1 <- rbind(df1, newdf)
newdf = read.delim("arabidopsis_assembly_lengths/genome_1_lengths.txt", header=TRUE)
colnames(newdf) <- c("assembly", "length")
newdf$assembly <- rep("lognormal_1", nrow(newdf))
df1 <- rbind(df1, newdf)
newdf = read.delim("arabidopsis_assembly_lengths/genome_2_lengths.txt", header=TRUE)
colnames(newdf) <- c("assembly", "length")
newdf$assembly <- rep("lognormal_2", nrow(newdf))
df1 <- rbind(df1, newdf)

ggplot(df1, aes(x=assembly, y=length, fill=assembly)) + geom_boxplot() + scale_y_log10() +
  labs(x ="arabidopsis denovo and modelled assemblies", y="length in bp", main=NULL) + mytheme + theme(legend.position="none")
...
df1 <- read.delim(file="arabidopsis_assembly_lengths/read_lengths_hasty.txt", header = FALSE)
...
V=qqplot(df1$V2, expon_r, xlab="Genome Fragments", ylab="exponential fit", cex.lab=1.5, cex.axis=1.5)
qqline2(df1$V2, expon_r)
k=lm(V$y ~ V$x)
leg_r2(k)
V=qqplot(df1$V2, lnorm_r, xlab="Genome Fragments", ylab="lognormal fit", cex.lab=1.5, cex.axis=1.5)
qqline2(df1$V2, lnorm_r)
k=lm(V$y ~ V$x)
leg_r2(k)
V=qqplot(df1$V2, normal_r, xlab="Genome Fragments", ylab="normal fit", cex.lab=1.5, cex.axis=1.5)
qqline2(df1$V2, normal_r)
k=lm(V$y ~ V$x)
leg_r2(k)
...
##### from the qqplots of the fragment lengths vs fitted data; arabidopsis assemblies are best summarised by a log-normal distribution
...
#### box plot of scaffold sequence lengths for rice assemblies from [Schatz et al 2014](http://www.genomebiology.com/2014/15/11/506)

```{r rice-boxplot, echo=FALSE, fig.width=12, fig.height=6}
df1 = read.delim("rice_assembly_lengths/nipponbare_all_lens.txt", header=FALSE)
colnames(df1) <- c("assembly", "length")
df1$assembly <- rep("nipponbare", nrow(df1))
newdf = read.delim("rice_assembly_lengths/dj123_all_lens.txt", header=FALSE)
colnames(newdf) <- c("assembly", "length")
newdf$assembly <- rep("dj123", nrow(newdf))
df1 <- rbind(df1, newdf)
newdf = read.delim("rice_assembly_lengths/ir64_all_lens.txt", header=FALSE)
colnames(newdf) <- c("assembly", "length")
newdf$assembly <- rep("ir64", nrow(newdf))
df1 <- rbind(df1, newdf)
newdf = read.delim("rice_assembly_lengths/genome_1_lengths.txt", header=TRUE)
colnames(newdf) <- c("assembly", "length")
newdf$assembly <- rep("exponential_1", nrow(newdf))
df1 <- rbind(df1, newdf)
newdf = read.delim("rice_assembly_lengths/genome_2_lengths.txt", header=TRUE)
colnames(newdf) <- c("assembly", "length")
newdf$assembly <- rep("exponential_2", nrow(newdf))
df1 <- rbind(df1, newdf)

ggplot(df1, aes(x=assembly, y=length, fill=assembly)) + geom_boxplot() + scale_y_log10() +
  labs(x ="rice de-novo and modelled assemblies", y="length in bp", main=NULL) + mytheme + theme(legend.position="none")
...
```{r rice-fit-distr, echo=FALSE, fig.width=12, fig.height=6}

df1 <- read.delim(file="rice_assembly_lengths/nipponbare_all_lens.txt", header = FALSE)
lenden <- density(df1$V2)
contiglen <- data.frame(x=lenden$x, y=lenden$y)
...
ggplot() + geom_line(data=contiglen, aes(x=x, y=y, colour="assembly lengths"), size=1) +
geom_line(data=exp_model, aes(x=x, y=y, colour="exponential fit"), size=1) + geom_line(data=normal_model, aes(x=x, y=y, colour="normal fit"), size=1) + scale_y_sqrt() + mytheme + theme(legend.position=c(0.85,0.9)) + labs(x ="contig lengths", y="density", main=NULL)
...
```{r qqplot-rice, echo=FALSE, fig.width=12, fig.height=4}

par(mfrow=c(1,3), mar=c(5,5,1,0.5))
V=qqplot(df1$V2, expon_r, xlab="rice scaffolds", ylab="exponential fit", cex.lab=1.5, cex.axis=1.5)
qqline2(df1$V2, expon_r)
k=lm(V$y ~ V$x)
leg_r2(k)
V=qqplot(df1$V2, lnorm_r, xlab="rice scaffolds", ylab="lognormal fit", cex.lab=1.5, cex.axis=1.5)
qqline2(df1$V2, lnorm_r)
k=lm(V$y ~ V$x)
leg_r2(k)
V=qqplot(df1$V2, normal_r, xlab="rice scaffolds", ylab="normal fit", cex.lab=1.5, cex.axis=1.5)
qqline2(df1$V2, normal_r)
k=lm(V$y ~ V$x)
leg_r2(k)
...
##### from the qqplots of the fragment lengths vs fitted data; rice assemblies are best summarised by an exponential distribution