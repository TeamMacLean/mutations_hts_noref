...
for (i in 1:10) {
  ...
  selected2 <- selected
  selected2[selected2$ratio < 1,]$ratio <- 0
  selected3 <- selected
  selected3[selected3$ratio < 3,]$ratio <- 0
  ...
  barplot(selected2$ratio, width=selected$width, col=selected$color, border=selected$color, main="ratios >= 1")
  barplot(selected3$ratio, width=selected$width, col=selected$color, border=selected$color, main="ratios >= 3")
