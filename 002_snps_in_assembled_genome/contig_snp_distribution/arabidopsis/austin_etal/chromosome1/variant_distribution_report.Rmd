...
ggplot(data=melted, aes(x=position, y=value)) + geom_bar(stat="identity", colour="#E69F00", fill="#E69F00") +
  ...
  geom_vline(xintercept = as.numeric(30206068), size=0.5)
...
tenkb <- read.delim(file="per-75000bp-fph1.vcf.txt", header = TRUE)
tenkb <- re_zero_ratio(tenkb, 0.01)
melted <- melt(tenkb, id.vars = "position")
ggplot(data=melted, aes(x=position, y=value)) + geom_bar(stat="identity", colour="#E69F00", fill="#E69F00") +
  facet_grid(variable ~ ., scales = "free") +
...
tenkb <- read.delim(file="per-200000bp-fph1.vcf.txt", header = TRUE)
tenkb <- re_zero_ratio(tenkb, 0.01)
melted <- melt(tenkb, id.vars = "position")
ggplot(data=melted, aes(x=position, y=value)) + geom_bar(stat="identity", colour="#E69F00", fill="#E69F00") +
  facet_grid(variable ~ ., scales = "free") +
...
tenkb <- read.delim(file="per-300000bp-fph1.vcf.txt", header = TRUE)
tenkb <- re_zero_ratio(tenkb, 0.01)
melted <- melt(tenkb, id.vars = "position")
ggplot(data=melted, aes(x=position, y=value)) + geom_bar(stat="identity", colour="#E69F00", fill="#E69F00") +
  facet_grid(variable ~ ., scales = "free") +
...
tenkb <- read.delim(file="per-400000bp-fph1.vcf.txt", header = TRUE)
tenkb <- re_zero_ratio(tenkb, 0.01)
melted <- melt(tenkb, id.vars = "position")
ggplot(data=melted, aes(x=position, y=value)) + geom_bar(stat="identity", colour="#E69F00", fill="#E69F00") +
  facet_grid(variable ~ ., scales = "free") +
...
tenkb <- read.delim(file="per-600000bp-fph1.vcf.txt", header = TRUE)
tenkb <- re_zero_ratio(tenkb, 0.01)
melted <- melt(tenkb, id.vars = "position")
ggplot(data=melted, aes(x=position, y=value)) + geom_bar(stat="identity", colour="#E69F00", fill="#E69F00") +
  facet_grid(variable ~ ., scales = "free") +
...
tenkb <- read.delim(file="per-700000bp-fph1.vcf.txt", header = TRUE)
tenkb <- re_zero_ratio(tenkb, 0.01)
melted <- melt(tenkb, id.vars = "position")
ggplot(data=melted, aes(x=position, y=value)) + geom_bar(stat="identity", colour="#E69F00", fill="#E69F00") +
  facet_grid(variable ~ ., scales = "free") +
...
tenkb <- read.delim(file="per-800000bp-fph1.vcf.txt", header = TRUE)
tenkb <- re_zero_ratio(tenkb, 0.01)
melted <- melt(tenkb, id.vars = "position")
ggplot(data=melted, aes(x=position, y=value)) + geom_bar(stat="identity", colour="#E69F00", fill="#E69F00") +
  facet_grid(variable ~ ., scales = "free") +
...
tenkb <- read.delim(file="per-900000bp-fph1.vcf.txt", header = TRUE)
tenkb <- re_zero_ratio(tenkb, 0.01)
melted <- melt(tenkb, id.vars = "position")
ggplot(data=melted, aes(x=position, y=value)) + geom_bar(stat="identity", colour="#E69F00", fill="#E69F00") +
  facet_grid(variable ~ ., scales = "free") +
...
tenkb <- read.delim(file="per-2500000bp-fph1.vcf.txt", header = TRUE)
tenkb <- re_zero_ratio(tenkb, 0.01)
melted <- melt(tenkb, id.vars = "position")
ggplot(data=melted, aes(x=position, y=value)) + geom_bar(stat="identity", colour="#E69F00", fill="#E69F00") +
  facet_grid(variable ~ ., scales = "free") +
...
infile <- read.delim(file="varposn-chromosome-fph1.vcf.txt", header = TRUE)
