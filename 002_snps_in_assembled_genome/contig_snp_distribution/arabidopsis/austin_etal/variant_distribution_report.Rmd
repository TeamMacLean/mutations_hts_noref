...
setwd("~/git-hub-repos/shyamrallapalli/mutations_hts_noref/002_snps_in_assembled_genome/contig_snp_distribution/arabidopsis/austin_etal")
...
tenkb <- read.delim(file="per-10000bp-fph1.vcf.txt", header = TRUE)
...
ggplot(data=tenkb, aes(x=position)) + stat_smooth(aes(y=ratio/sum(ratio), colour="homozygous to heterozygous ratio"),
  ...
  geom_vline(xintercept = as.numeric(30206068), size=0.5, linetype = "longdash") +
...
tenkb <- read.delim(file="per-50000bp-fph1.vcf.txt", header = TRUE)
tenkb$numhm <- tenkb$numhm + 0.1
tenkb$numht <- tenkb$numht + 0.1
tenkb$ratio <- tenkb$numhm/tenkb$numht
ggplot(data=tenkb, aes(x=position)) + stat_smooth(aes(y=ratio/sum(ratio), colour="homozygous to heterozygous ratio"),
...
tenkb <- read.delim(file="per-100000bp-fph1.vcf.txt", header = TRUE)
tenkb$numhm <- tenkb$numhm + 0.1
tenkb$numht <- tenkb$numht + 0.1
tenkb$ratio <- tenkb$numhm/tenkb$numht
ggplot(data=tenkb, aes(x=position)) + stat_smooth(aes(y=ratio/sum(ratio), colour="homozygous to heterozygous ratio"),
...
tenkb <- read.delim(file="per-500000bp-fph1.vcf.txt", header = TRUE)
tenkb$numhm <- tenkb$numhm + 0.1
tenkb$numht <- tenkb$numht + 0.1
tenkb$ratio <- tenkb$numhm/tenkb$numht
ggplot(data=tenkb, aes(x=position)) + stat_smooth(aes(y=ratio/sum(ratio), colour="homozygous to heterozygous ratio"),
...
tenkb <- read.delim(file="per-1000000bp-fph1.vcf.txt", header = TRUE)
tenkb$numhm <- tenkb$numhm + 0.1
tenkb$numht <- tenkb$numht + 0.1
tenkb$ratio <- tenkb$numhm/tenkb$numht
ggplot(data=tenkb, aes(x=position)) + stat_smooth(aes(y=ratio/sum(ratio), colour="homozygous to heterozygous ratio"),
...
tenkb <- read.delim(file="per-5000000bp-fph1.vcf.txt", header = TRUE)
tenkb$numhm <- tenkb$numhm + 0.1
tenkb$numht <- tenkb$numht + 0.1
tenkb$ratio <- tenkb$numhm/tenkb$numht
ggplot(data=tenkb, aes(x=position)) + stat_smooth(aes(y=ratio/sum(ratio), colour="homozygous to heterozygous ratio"),
...
tenkb <- read.delim(file="per-10000000bp-fph1.vcf.txt", header = TRUE)
tenkb$numhm <- tenkb$numhm + 0.1
tenkb$numht <- tenkb$numht + 0.1
tenkb$ratio <- tenkb$numhm/tenkb$numht
ggplot(data=tenkb, aes(x=position)) + stat_smooth(aes(y=ratio/sum(ratio), colour="homozygous to heterozygous ratio"),
...
infile <- read.delim(file="varposn-genome-fph1.vcf.txt", header = TRUE)
