...
ggplot(data=melted, aes(x=position, y=value)) + geom_bar(stat="identity", colour="#E69F00", fill="#E69F00") +
  ...
  geom_vline(xintercept = as.numeric(18807538), size=0.5)
...
tenkb <- read.delim(file="per-75000bp-filtered_96_1_fd2_mutant.vcf.txt", header = TRUE)
tenkb <- re_zero_ratio(tenkb, 1)
melted <- melt(tenkb, id.vars = "position")
ggplot(data=melted, aes(x=position, y=value)) + geom_bar(stat="identity", colour="#E69F00", fill="#E69F00") +
  facet_grid(variable ~ ., scales = "free") +
...
tenkb <- read.delim(file="per-200000bp-filtered_96_1_fd2_mutant.vcf.txt", header = TRUE)
tenkb <- re_zero_ratio(tenkb, 1)
melted <- melt(tenkb, id.vars = "position")
ggplot(data=melted, aes(x=position, y=value)) + geom_bar(stat="identity", colour="#E69F00", fill="#E69F00") +
  facet_grid(variable ~ ., scales = "free") +
...
tenkb <- read.delim(file="per-300000bp-filtered_96_1_fd2_mutant.vcf.txt", header = TRUE)
tenkb <- re_zero_ratio(tenkb, 1)
melted <- melt(tenkb, id.vars = "position")
ggplot(data=melted, aes(x=position, y=value)) + geom_bar(stat="identity", colour="#E69F00", fill="#E69F00") +
  facet_grid(variable ~ ., scales = "free") +
...
tenkb <- read.delim(file="per-400000bp-filtered_96_1_fd2_mutant.vcf.txt", header = TRUE)
tenkb <- re_zero_ratio(tenkb, 1)
melted <- melt(tenkb, id.vars = "position")
ggplot(data=melted, aes(x=position, y=value)) + geom_bar(stat="identity", colour="#E69F00", fill="#E69F00") +
  facet_grid(variable ~ ., scales = "free") +
...
tenkb <- read.delim(file="per-600000bp-filtered_96_1_fd2_mutant.vcf.txt", header = TRUE)
tenkb <- re_zero_ratio(tenkb, 1)
melted <- melt(tenkb, id.vars = "position")
ggplot(data=melted, aes(x=position, y=value)) + geom_bar(stat="identity", colour="#E69F00", fill="#E69F00") +
  facet_grid(variable ~ ., scales = "free") +
...
tenkb <- read.delim(file="per-700000bp-filtered_96_1_fd2_mutant.vcf.txt", header = TRUE)
tenkb <- re_zero_ratio(tenkb, 1)
melted <- melt(tenkb, id.vars = "position")
ggplot(data=melted, aes(x=position, y=value)) + geom_bar(stat="identity", colour="#E69F00", fill="#E69F00") +
  facet_grid(variable ~ ., scales = "free") +
...
tenkb <- read.delim(file="per-800000bp-filtered_96_1_fd2_mutant.vcf.txt", header = TRUE)
tenkb <- re_zero_ratio(tenkb, 1)
melted <- melt(tenkb, id.vars = "position")
ggplot(data=melted, aes(x=position, y=value)) + geom_bar(stat="identity", colour="#E69F00", fill="#E69F00") +
  facet_grid(variable ~ ., scales = "free") +
...
tenkb <- read.delim(file="per-900000bp-filtered_96_1_fd2_mutant.vcf.txt", header = TRUE)
tenkb <- re_zero_ratio(tenkb, 1)
melted <- melt(tenkb, id.vars = "position")
ggplot(data=melted, aes(x=position, y=value)) + geom_bar(stat="identity", colour="#E69F00", fill="#E69F00") +
  facet_grid(variable ~ ., scales = "free") +
...
tenkb <- read.delim(file="per-2500000bp-filtered_96_1_fd2_mutant.vcf.txt", header = TRUE)
tenkb <- re_zero_ratio(tenkb, 1)
melted <- melt(tenkb, id.vars = "position")
ggplot(data=melted, aes(x=position, y=value)) + geom_bar(stat="identity", colour="#E69F00", fill="#E69F00") +
  facet_grid(variable ~ ., scales = "free") +
...
infile <- read.delim(file="varposn-chromosome-filtered_96_1_fd2_mutant.vcf.txt", header = TRUE)
