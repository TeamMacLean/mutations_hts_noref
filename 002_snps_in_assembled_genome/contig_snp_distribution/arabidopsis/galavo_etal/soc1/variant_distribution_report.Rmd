...
setwd("~/git-hub-repos/shyamrallapalli/mutations_hts_noref/002_snps_in_assembled_genome/contig_snp_distribution/arabidopsis/galavo_etal/96_1_fd2")
...
ggplot(data=tenkb, aes(x=position)) + stat_smooth(aes(y=ratio/sum(ratio), colour="homozygous to heterozygous ratio"),
  ...
  geom_vline(xintercept = as.numeric(49235209), size=0.5, linetype = "longdash") +
