...
tenkb <- read.delim(file="per-5000000bp-filtered_sup2_colT_wsT.vcf.txt", header = TRUE)
tenkb$numhm <- tenkb$numhm + 0.1
tenkb$numht <- tenkb$numht + 0.1
tenkb$ratio <- tenkb$numhm/tenkb$numht
ggplot(data=tenkb, aes(x=position)) + stat_smooth(aes(y=ratio/sum(ratio), colour="homozygous to heterozygous ratio"),
...
tenkb <- read.delim(file="per-10000000bp-filtered_sup2_colT_wsT.vcf.txt", header = TRUE)
tenkb$numhm <- tenkb$numhm + 0.1
tenkb$numht <- tenkb$numht + 0.1
tenkb$ratio <- tenkb$numhm/tenkb$numht
ggplot(data=tenkb, aes(x=position)) + stat_smooth(aes(y=ratio/sum(ratio), colour="homozygous to heterozygous ratio"),
...
infile <- read.delim(file="varposn-genome-filtered_sup2_colT_wsT.vcf.txt", header = TRUE)
