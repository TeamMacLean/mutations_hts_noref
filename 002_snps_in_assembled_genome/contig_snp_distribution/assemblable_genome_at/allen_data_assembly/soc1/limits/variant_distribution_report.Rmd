...
tenkb <- read.delim(file="2000000-per10000bp-filtered_96_1_fd2_mutant.vcf.txt", header = TRUE)
...
tenkb <- read.delim(file="2000000-per50000bp-filtered_96_1_fd2_mutant.vcf.txt", header = TRUE)
tenkb <- re_zero_ratio(tenkb, 0.01)
tenkb$length <- NULL
melted <- melt(tenkb, id.vars = "position")
ggplot(data=melted, aes(x=position, y=value)) + geom_bar(stat="identity", colour="#E69F00", fill="#E69F00") +
...
tenkb <- read.delim(file="2000000-per100000bp-filtered_96_1_fd2_mutant.vcf.txt", header = TRUE)
tenkb <- re_zero_ratio(tenkb, 0.01)
tenkb$length <- NULL
melted <- melt(tenkb, id.vars = "position")
ggplot(data=melted, aes(x=position, y=value)) + geom_bar(stat="identity", colour="#E69F00", fill="#E69F00") +
...
tenkb <- read.delim(file="20000000-per10000bp-filtered_96_1_fd2_mutant.vcf.txt", header = TRUE)
tenkb <- re_zero_ratio(tenkb, 0.01)
tenkb$length <- NULL
melted <- melt(tenkb, id.vars = "position")
ggplot(data=melted, aes(x=position, y=value)) + geom_bar(stat="identity", colour="#E69F00", fill="#E69F00") +
  facet_grid(variable ~ ., scales = "free") +
  scale_y_sqrt() + labs(y=NULL, main="genome in 10 KB fragment chunks") + mytheme +
  geom_vline(xintercept = as.numeric(10000000), size=0.5)
...
tenkb <- read.delim(file="20000000-per100000bp-filtered_96_1_fd2_mutant.vcf.txt", header = TRUE)
tenkb <- re_zero_ratio(tenkb, 0.01)
tenkb$length <- NULL
melted <- melt(tenkb, id.vars = "position")
ggplot(data=melted, aes(x=position, y=value)) + geom_bar(stat="identity", colour="#E69F00", fill="#E69F00") +
...
tenkb <- read.delim(file="20000000-per500000bp-filtered_96_1_fd2_mutant.vcf.txt", header = TRUE)
tenkb <- re_zero_ratio(tenkb, 0.01)
tenkb$length <- NULL
melted <- melt(tenkb, id.vars = "position")
ggplot(data=melted, aes(x=position, y=value)) + geom_bar(stat="identity", colour="#E69F00", fill="#E69F00") +
...
tenkb <- read.delim(file="2000000-perassemblybp-filtered_96_1_fd2_mutant.vcf.txt", header = TRUE)
tenkb <- re_zero_ratio(tenkb, 0.01)
...
tenkb <- read.delim(file="5000000-perassemblybp-filtered_96_1_fd2_mutant.vcf.txt", header = TRUE)
tenkb <- re_zero_ratio(tenkb, 0.01)
tenkb$ratio_norm <- tenkb$ratio/tenkb$length
tenkb$length <- NULL
melted <- melt(tenkb, id.vars = "position")
...
tenkb <- read.delim(file="10000000-perassemblybp-filtered_96_1_fd2_mutant.vcf.txt", header = TRUE)
tenkb <- re_zero_ratio(tenkb, 0.01)
tenkb$ratio_norm <- tenkb$ratio/tenkb$length
tenkb$length <- NULL
melted <- melt(tenkb, id.vars = "position")
...
tenkb <- read.delim(file="20000000-perassemblybp-filtered_96_1_fd2_mutant.vcf.txt", header = TRUE)
tenkb <- re_zero_ratio(tenkb, 0.01)
tenkb$ratio_norm <- tenkb$ratio/tenkb$length
tenkb$length <- NULL
melted <- melt(tenkb, id.vars = "position")
